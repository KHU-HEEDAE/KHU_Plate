...
class WriteReviewPopup extends StatefulWidget {
  const WriteReviewPopup({Key? key, this.food}) : super(key: key);
  ...
  static _WriteReviewPopupState? of(BuildContext context) =>
      context.findAncestorStateOfType<_WriteReviewPopupState>();
}
